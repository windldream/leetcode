...
var StockPrice = function () {
  this.maxFq = new FastPriorityQueue((a, b) => a[1] > b[1])
  this.minFq = new FastPriorityQueue((a, b) => a[1] < b[1])
...
StockPrice.prototype.update = function (timestamp, price) {
  ...
  if (this.timeMap.has(timestamp)) {
    this.maxFq.removeOne((stock) => stock[0] === timestamp)
    this.minFq.removeOne((stock) => stock[0] === timestamp)
  }

  this.maxFq.add([timestamp, price])
  this.minFq.add([timestamp, price])
...
StockPrice.prototype.current = function () {
  return this.timeMap.get(this.cur)
}
